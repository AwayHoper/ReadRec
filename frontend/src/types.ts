...
export interface SessionWordSummary { id: string; vocabularyItemId: string; type: 'NEW' | 'REVIEW'; status: string; isSelectedUnknown: boolean; reviewAttempts: number; word?: string; phonetic?: string; definitions?: string[]; senses?: VocabularySense[]; }
